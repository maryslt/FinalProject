...
public class faal extends AppCompatActivity {
        ...
        private void getFaal() {
            ...
            Call<falha> call = falApi.getFal();
            call.enqueue(new Callback<falha>() {
                @Override
                public void onResponse(Call<falha> call, Response<falha> response) {
                    if (response.isSuccessful()) {
                        falha faal = response.body();
                ...
                @Override
                public void onFailure(Call<falha> call, Throwable t) {
